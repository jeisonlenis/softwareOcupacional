...
import sessions.ContratosFacade;
...
public class ContratosController implements Serializable {
    ...
    @EJB
    private sessions.ContratosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ContratosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ContratosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ContratosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class ContratosControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Contratos) {
                ...
                return getStringKey(o.getIdCont());
            } else {
